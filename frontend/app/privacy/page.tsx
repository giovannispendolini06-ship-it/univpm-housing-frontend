      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-ink">
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-5">
              <li>
                <strong>Fornire il servizio</strong> di marketplace abitativo: ricerca e
                abbinamento tra studenti e annunci di proprietari, senza che Coabito sia parte
                del contratto di locazione — base giuridica: esecuzione di un contratto con te
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>
                Studenti e proprietari, limitatamente alle informazioni necessarie a facilitare
                l&apos;abbinamento e il contatto sul marketplace (es. un proprietario vede il
                numero di studenti compatibili o, ove previsto, elementi di profilo utili alla
                selezione; i dati personali sensibili restano gestiti da noi secondo questa
                informativa). Il contratto di locazione, se concluso, resta diretto tra le parti
              </li>
