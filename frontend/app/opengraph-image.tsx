    ...
    (
      <div
        style={{
          ...
          backgroundImage:
            "radial-gradient(ellipse 700px 500px at 85% 20%, rgba(255,107,74,0.35), transparent 60%), radial-gradient(ellipse 800px 600px at 10% 90%, rgba(8,47,45,0.55), transparent 55%)",
          color: "#ffffff",
