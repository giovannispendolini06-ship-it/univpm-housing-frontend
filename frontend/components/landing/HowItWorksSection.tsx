    ...
    >
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-20">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-3">
          {steps.map((step) => (
            <div key={step.number} className="rounded-xl2 bg-surface p-5 shadow-card">
        ...
        <a
          href={ctaHref}
          className="mt-8 inline-flex rounded-full bg-sunset-500 px-6 py-3 text-sm font-semibold text-white transition hover:bg-sunset-600"
        >
          {ctaLabel}
        </a>
      </div>
