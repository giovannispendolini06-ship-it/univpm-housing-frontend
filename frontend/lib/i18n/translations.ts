...
export const translations = {
  it: {
    ...
    listingsFilters: {
      ...
      propStanzaSingola: "Stanza singola",
      propStanzaDoppia: "Stanza doppia",
      propAppartamentoIntero: "Appartamento intero",
      propMonolocale: "Monolocale",
      sizeS: "Fino a 12",
      sizeM: "12-18",
      sizeL: "18+",
      availNow: "Da subito",
      availSept: "Da settembre",
      durataAnnoAccademico: "Anno accademico",
      durataAnnuale: "Annuale",
      durataBrevePeriodo: "Breve periodo",
      durataFlessibile: "Flessibile",
      flatmates3plus: "3+",
    ...
    listingsMap: {
      ...
      emptyPoints: "Nessuna stanza da mostrare sulla mappa con i filtri attuali.",
      tokenMissingTitle: "Mappa non configurata",
      tokenMissingBody:
        "Aggiungi NEXT_PUBLIC_MAPBOX_TOKEN su Vercel (token Mapbox pk.…) e ridistribuisci. L’elenco resta disponibile.",
    },
    roleMaps: {
      ownerTitle: "I tuoi immobili sulla mappa",
      ownerSubtitle: "Panoramica delle case che hai messo in affitto su Coabito.",
      ownerPrivacyNote: "Pin sulla zona o sulle coordinate salvate dell’immobile.",
      ownerEmpty: "Nessun immobile da posizionare sulla mappa.",
      adminTitle: "Panoramica marketplace",
      adminSubtitle:
        "Dove opera Coabito: città e densità di immobili sul marketplace.",
      adminPrivacyNote: "Vista operativa admin — pin per zona o coordinate.",
      adminEmpty: "Nessun immobile da mostrare sulla mappa.",
      allCities: "Tutte le città",
      unknownCity: "Città non indicata",
  ...
  en: {
    ...
    listingsFilters: {
      ...
      propStanzaSingola: "Single room",
      propStanzaDoppia: "Double room",
      propAppartamentoIntero: "Whole apartment",
      propMonolocale: "Studio",
      sizeS: "Up to 12",
      sizeM: "12-18",
      sizeL: "18+",
      availNow: "Immediate",
      availSept: "From September",
      durataAnnoAccademico: "Academic year",
      durataAnnuale: "Annual",
      durataBrevePeriodo: "Short term",
      durataFlessibile: "Flexible",
      flatmates3plus: "3+",
    ...
    listingsMap: {
      ...
      emptyPoints: "No rooms to show on the map with the current filters.",
      tokenMissingTitle: "Map not configured",
      tokenMissingBody:
        "Add NEXT_PUBLIC_MAPBOX_TOKEN on Vercel (Mapbox pk.… token) and redeploy. The list view still works.",
    },
    roleMaps: {
      ownerTitle: "Your properties on the map",
      ownerSubtitle: "Overview of homes you’ve listed on Coabito.",
      ownerPrivacyNote: "Pins use the area or saved property coordinates.",
      ownerEmpty: "No properties to place on the map yet.",
      adminTitle: "Marketplace overview",
      adminSubtitle:
        "Where Coabito operates: cities and listing density across the marketplace.",
      adminPrivacyNote: "Admin operational view — pins by area or coordinates.",
      adminEmpty: "No properties to show on the map.",
