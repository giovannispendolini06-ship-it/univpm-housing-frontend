 ...
 *
 * Accetta formati comuni:
 * - `393758222238` (internazionale senza +) — formato consigliato per
 *   NEXT_PUBLIC_WHATSAPP_NUMBER
 * - `+393758222238`
 * - `3758222238` / `03758222238` (nazionale IT)
 *
 * Non antepone un secondo `39` se il numero è già in formato internazionale.
 */
...
export function normalizeWhatsAppDigits(phone: string): string | null {
  ...
  // Altro prefisso paese già presente (10+ cifre, non inizia con 0)
